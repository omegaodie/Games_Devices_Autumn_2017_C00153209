...
void LevelLoader::loadGameData()
{
	...
	ptr->m_mainMenu_Back = MainMenu["back_file"].GetString();

	ptr->m_mainMenu_btn1_plist = MainMenu["play_button_plist"].GetString();
	ptr->m_mainMenu_btn1_ss = MainMenu["play_button_ss"].GetString();
	...
	ptr->m_pauseMenu_Back = PauseMenu["back_file"].GetString();
	...
	ptr->m_game_Back = Game["back_file"].GetString();
	ptr->m_game_pause_noclick = Game["button_pause_1"].GetString();
	ptr->m_game_pause_click = Game["button_pause_2"].GetString();

	ptr->m_game_test_sheet = Game["test_ss"].GetString();
	ptr->m_game_test_plist = Game["test_plist"].GetString();

	ptr->m_game_fireball_sheet = Game["fireball_1_ss"].GetString();
	ptr->m_game_fireball_plist = Game["fireball_1_plist"].GetString();


	//ptr->m_mainMenuBack = it1->value.GetString();
	//it1++;
	//ptr->m_mainMenuBack = it1->value.GetString();
	//it1++;
	//ptr->m_mainMenuBack = it1->value.GetString();
